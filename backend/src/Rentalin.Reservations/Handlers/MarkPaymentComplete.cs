...
public sealed class MarkPaymentCompleteHandler : IRequestHandler<MarkPaymentCompleteRequest, PaymentResponse>
{
    private readonly IRepository<Payment> _payments;
    private readonly IUnitOfWork _unitOfWork;

    public MarkPaymentCompleteHandler(IRepository<Payment> payments, IUnitOfWork unitOfWork)
    {
        _payments = payments;
        _unitOfWork = unitOfWork;
    }

    public async Task<PaymentResponse> Handle(MarkPaymentCompleteRequest request, CancellationToken ct)
    {
